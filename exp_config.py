...
tf.app.flags.DEFINE_string('train_dir', './log/depth_mini_1','Directory where to write event logs and checkpoint.')
tf.app.flags.DEFINE_string('eval_dir', './log/depth_eval_mini_1', 'save eval')
